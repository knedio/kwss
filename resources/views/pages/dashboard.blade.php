        ...
        <div class="col-xs-12">
            <div style="padding:20px;border: 1px solid #ccc;border-radius: 8px;">
                ...
                <div style="padding-bottom:10px;">
                    <a href="{{ route('pdf_disconnected_list_all') }}" class="btn btn-primary btn-sm"> Export All Data</a> 
                    <a href="{{ route('pdf_disconnected_list',['dm'=>$dm,'dy'=>$dy]) }}" class="btn btn-success btn-sm"> Export Filtered Data</a> 
                </div>
                <div class="table-responsive" style="padding-bottom:5em;">
