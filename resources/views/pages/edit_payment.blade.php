...
<div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="cus_id" readonly value="{{ ucwords(strtolower($records{0}->cus_firstname.' '.$records{0}->cus_lastname)) }}" id="" >
                </div>
            </div>
            <div class="col-xs-12 col-md-6">
                <div class="form-group">
                    <label for="emp_id">Received By: </label>
                    <input type="text" class="form-control" name="emp_id" readonly value="{{ ucwords(strtolower($records{0}->emp_firstname.' '.$records{0}->emp_lastname)) }}" id="" >
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="reader_id" readonly value="{{ ucwords(strtolower($records{0}->reader_firstname.' '.$records{0}->reader_lastname)) }}" id="" >
                </div>
            </div>
            <div class="col-xs-12 col-md-6">
                <div class="form-group">
                    <label for="pay_status">Payment Status : </label>
                    <input type="text" class="form-control" name="pay_status" readonly value="{{ $records{0}->pay_status }}" id="" >
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="reading_date" readonly value="{{ date('Y-m-d',strtotime($records{0}->reading_date)) }}" id="" >
                </div>
            </div>
            <div class="col-xs-12 col-md-6">
                <div class="form-group">
                    <label for="">Due Date: </label>
                    <input type="text" class="form-control" name="" readonly value="{{ $records{0}->due_date }}" id="" >
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="reading_waterconsumed" readonly value="{{ number_format($records{0}->reading_waterconsumed,2) }}" id="" >
                </div>
            </div>
            <div class="col-xs-12 col-md-6">
                <div class="form-group">
                    <label for="reading_waterconsumed">Reading Payment (₱) : </label>
                    <input type="text" class="form-control" name="reading_waterconsumed" readonly value="{{ number_format($records{0}->reading_amount,2) }}" id="" >
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-md-8">
                            <input type="text" class="form-control" name="" readonly value="{{$records{0}->reading_other_payment_name}}" id="" >
                        </div>
                        <div class="col-xs-12 col-sm-4 col-md-4">
                            <input type="text" class="form-control" name="reading_waterconsumed" readonly value="{{ number_format($records{0}->reading_other_payment,2) }}" id="" >
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="due_date_penalty_amount" readonly value="" id="" >
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="total_payment_amount" readonly value="{{ number_format($records{0}->reading_other_payment,2) }}" id="" >
                </div>
            </div>
        </div>
    </form> 
    ...
    <form action="{{ route('update-payment') }}" method="post">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" class="form-control" name="trans_payment" value="{{ $record->trans_payment }}" id="" >
                </div>
            </div>
            <div class="col-xs-12 col-md-6">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="trans_date" readonly value="{{ ( $record->trans_date ? date('Y-m-d',strtotime($record->trans_date)) : '' ) }}" id="" >
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
                <a href="{{ route('payments') }}" class="btn btn-default">Back</a>
        ...
        <input type="hidden" name="zone" value="{{$record->cus_zone}}">
    </form>
    <hr />
    @php    
        $count++;
    ...
    @php    
        ...
        $payment_amount = check_if_penalty($duration,$reading_date,$reading_amount,$penalty,$zone,$other_payment,$partial_payment,$pay_status);
