...
-- Date: Sun, 20 Jan 2019 00:02:27 +0800
...
SET autocommit=0;
INSERT INTO `tbl_customer` VALUES (1,36,'Test','Customer','9652354567','Tests','Zone Test',0),(2,37,'Customer','Juan','9652354567','CDO',NULL,11);
...
SET autocommit=0;
INSERT INTO `tbl_employee` VALUES (14,35,'Admin','Admin','9652354567','CDO');
...
CREATE TABLE `tbl_meter_reading` (
  ...
  `reading_amount` int(11) DEFAULT NULL,
  `reading_other_payment` float DEFAULT '0',
...
SET autocommit=0;
INSERT INTO `tbl_meter_reading` VALUES (1,1,2,'2019-01-18 00:00:00',0,'11',112,100,'Read',NULL);
/*!40000 ALTER TABLE `tbl_meter_reading` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `tbl_meter_reading` with 1 row(s)
--
...
-- Dumped table `tbl_payment` with 0 row(s)
--
...
-- Dumped table `tbl_payment_details` with 0 row(s)
--
...
SET autocommit=0;
INSERT INTO `tbl_request` VALUES (2,1,'a:2:{s:10:\"first name\";s:8:\"Customer\";s:9:\"last name\";s:9:\"Dela Cruz\";}','a:2:{s:10:\"first name\";s:4:\"Test\";s:9:\"last name\";s:8:\"Customer\";}','Name','Declined','2019-01-19 09:17:10'),(3,1,'a:2:{s:7:\"address\";s:3:\"CDO\";s:4:\"zone\";N;}','a:2:{s:7:\"address\";s:5:\"Tests\";s:4:\"zone\";s:9:\"Zone Test\";}','Address','Approved','2019-01-19 09:20:04');
/*!40000 ALTER TABLE `tbl_request` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `tbl_request` with 2 row(s)
--
...
-- Dump completed on: Sun, 20 Jan 2019 00:02:28 +0800
