...
<div class="container-fluid">
    ...
    @php    
        ...
        $payment_amount_no_f = check_if_penalty($duration,$reading_date,$reading_amount,$penalty,$other_payment,$partial_payment,$pay_status,FALSE,FALSE);
        $payment_amount = check_if_penalty($duration,$reading_date,$reading_amount,$penalty,$other_payment,$partial_payment,$pay_status);
