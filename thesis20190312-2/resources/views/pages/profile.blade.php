        ...
        <div class="row">
            <div class="col-xs-6">
                ...
                {{-- @if(session('account_type') == 'Customer')
                    <input type="hidden" name="account_type" id="account_type" value="{{session('account_type')}}">
                @elseif(session('account_type') != 'Customer')
                <div class="form-group">
                    <label for="account_type">Account Type <span class="text-red">*</span>:</label>
                    <select class="form-control" id="account_type" name="account_type">
                        <option value="" disabled>-- Select Account Type --</option>
                        @if(session('account_type') == 'Admin')
                        <option {{($record->account_type=='Admin')? 'selected' : ''}} value="Admin">Admin</option>
                        @endif
                        <option {{($record->account_type=='Employee')? 'selected' : ''}} value="Employee">Employee</option>
                        <option {{($record->account_type=='Customer')? 'selected' : ''}} value="Customer">Customer</option>
                        <option {{($record->account_type=='Water Reader')? 'selected' : ''}} value="Water Reader">Water Reader</option>
                    </select>
                </div>
                @endif --}}
                <div class="form-group">
            ...
            <div class="col-xs-6">
                ...
                <div id="password_section" class="hide-content">
                    ...
                    {{-- <div class="form-group">
                        ...
                        <input type="password" class="form-control" disabled name="confirm_password" autocomplete="off" id="confirm_password" value="" placeholder="***">
                    </div> --}}
                </div>
                @endif
            </div>
                                ...
                                <div class="col-xs-6">
                                    <h4>
                                        ...
                                        {{-- @if($m_rec->meter_id)
                                            ...
                                            @else
                                                <button class="btn btn-xs btn-danger btn_remove_meter" id="btn_remove_meter{{$count+1}}" type="button" data-id="{{$count+1}}">
                                                    Remove
                                                </button>
                                            @endif
                                        @endif --}}
