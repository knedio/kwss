...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12 distance" style="padding-top:20px; padding-bottom: 20px;">
            ...
            <li class="active"><a data-toggle="tab" href="#all">All Monthly Reading</a></li>
            <li><a data-toggle="tab" href="#unread">Unread Customer</a></li>
            <li><a data-toggle="tab" href="#read">Read Customer</a></li>
            </ul>
        </div>
