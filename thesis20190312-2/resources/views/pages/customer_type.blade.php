                        ...
                        @foreach($records as $record)
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{-- @php
                                        // printx($record->custype_previous_data);
                                       $unserialized = unserialize($record->custype_previous_data);
                                    @endphp --}}
                                    <a href="{{ route('get-custype-old-by-id',['id'=>$record->custype_id]) }}"><span class="label label-success">View Prev Data</span></a>
                                    {{-- <a href="#prev_custype" 
                                        data-toggle="modal" 
                                        data-id="{{$unserialized->custype_id}}" 
                                        data-type="{{$unserialized->custype_type}}" 
                                        data-min-cubic-meter="{{$unserialized->custype_min_cubic_meter}}" 
                                        data-cubic-meter-rate="{{$unserialized->custype_cubic_meter_rate}}" 
                                        data-min-peso-rate="{{$unserialized->custype_min_peso_rate}}"
                                        data-duration="{{$unserialized->custype_due_date_duration}}"
                                        data-penalty="{{$unserialized->custype_due_date_penalty}}">
                                        <span class="label label-success">View Prev Data</span>
                                    </a> --}}
                                    @endif
                                    <a href="#edit_custype" 
                                        data-toggle="modal" 
